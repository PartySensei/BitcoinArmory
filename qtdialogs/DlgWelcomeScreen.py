...
# Consolidated styles for UI elements
DIALOG_STYLE = """
    QDialog {
...
class DlgWelcomeScreen(QtWidgets.QDialog):
    ...
    def createIntroSection(self):
        ...
        introText = createStyledLabel("""
            <p style="color: white; font-size: 10pt; margin: 0;">
    ...
    def createRequirementsSection(self):
        ...
        reqHeader = createStyledLabel(
            '<span style="color: #E5A922; font-size: 10pt;"><b>System Requirements Check:</b></span>')
    ...
    def createButtonSection(self):
        ...
        # Get Started Button
        self.getStartedBtn = createStyledButton('Get Started', GET_STARTED_BUTTON_STYLE)
    ...
    def createVersionSection(self):
        ...
        versionText = createStyledLabel("""
            <div style="color: white; font-size: 8pt; text-align: center; line-height: 1.2;">
    ...
    def updateSystemRequirements(self, requirements):
        ...
        def createStatusText(requirement, name):
            ...
            color = '#1EBA17' if requirement else '#FF4444'
